 ...
 */
class NowPlayingListAdapter(c: Context, list: List<YouTubeVideo>?) : RecyclerView.Adapter<NowPlayingListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val viewCount: TextView = itemView.findViewById(R.id.videos_number) as TextView
